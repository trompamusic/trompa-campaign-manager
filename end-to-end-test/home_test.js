...
Scenario('Going to landing page viewing the first section', async ({ I }) => {
  ...
  I.seeVisualDiff("landing_page.png", { tolerance: 1, prepareBaseImage: false });
...
Scenario('View the second section', async ({ I }) => {
  ...
  I.seeVisualDiff("landing_page_steps.png", { tolerance: 1, prepareBaseImage: true });
...
Scenario('View the active campaigns', async ({ I }) => {
  ...
  I.seeVisualDiff("landing_page_active_campaigns.png", { tolerance: 1, prepareBaseImage: false });
...
Scenario('View the Supported by', async ({ I }) => {
  ...
  I.seeVisualDiff("landing_page_supported_by.png", { tolerance: 1, prepareBaseImage: false });
